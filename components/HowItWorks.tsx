...
function StepCard({ step, title, description }: { step: number; title: string; description: string }) {
  return (
    <div className="bg-[#1c1c1c] p-8 rounded-xl border border-white/10 hover:border-[#3ECF8E]/50 transition-colors relative group">
      ...
      <div className="w-12 h-12 rounded-full bg-[#3ECF8E]/10 text-[#3ECF8E] flex items-center justify-center font-bold text-xl mb-6 border border-[#3ECF8E]/20">{step}</div>
